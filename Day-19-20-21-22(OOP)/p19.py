...
Class :
A class is a blueprint/template used to create objects. It defines properties (attributes) and 
behaviors (methods).
...
3. Bank Account → has properties like account_number, balance and behaviors like deposit(), withdraw(), 
check_balance().
